...
%         end
        ...
        % not current handled other than by throwing an error.
            ...
            % if not eye trackers found after x number of retries, or if
...
%             time = time + obj.PosixTimeOffset;
        ...
        function CalibratePoint(obj, x, y)
        ...
        function success = ComputeCalibration(obj)
        ...
        % these as a measure of data quality with the datafile. 
            ...
            % if the class hasn't been calibrated before, not the success
            % or otherwise
