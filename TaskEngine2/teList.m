    ...
    methods
        ...
        function CustomSetTable(obj, val)
            ...
            varsPresent = all(cellfun(@(x)...
                ismember(x, lower(obj.prTable.Properties.VariableNames)),...
                reqVars));
            if ~varsPresent
            ...
            if obj.prDoConRep
                ...
                while ~repHappy
                    ...
                    if ~repHappy
                        ...
                        iter = iter + 1;
                        if iter > 1000
                            error('Tried 1000 order permutations and could not meet control repeats contraints.')
                        end
                    end
