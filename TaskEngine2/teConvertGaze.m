function [conv, timeBuffer] = teConvertGaze(gaze, time, from, to, goFast)
...
% normal situations. 
    ...
    if ~goFast
        validFormats = {'taskEngine2', 'tobiiAnalytics', 'tobiiPro', 'xyt'};
        ...
        if ~isempty(time) && any(strcmpi(from, {'taskEngine2', 'tobiiAnalytics'}))
            ...
            % first column will have timestamps, and the second will have
