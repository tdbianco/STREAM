function teSyncEEG_fieldtrip(data_te, data_ft)
...
% extract te event data
    ...
    lg = teLogFilter(data_te.Log, 'source', 'teEventRelay_Log');
...
% find sync markers in EEG
    ...
    help l% look up reg event for sync
    ev_sync = registeredEvents('SYNC');
    if isempty(ev_sync)
