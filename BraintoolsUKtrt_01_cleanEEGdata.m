...
load '/Users/teresa/Documents/MATLAB/data/stream/0_stream_Trt/stream_IDs_tracking_wETint_man.mat'

PPTfolder = dir('/Users/teresa/Documents/MATLAB/data/stream');
    Nrows = height(stream_IDs_tracking_wETint);
...
% remove ppts with < 20 trials
%it's impossible in fucking matlab of my fucking fucking. removing
%manually. 
...
for ss = 82:height(stream_ClnEEG)

    fprintf('Currently nr %i out of %i\n',ss,height(stream_ClnEEG))
    Subj = stream_IDs_tracking_wETint.ID{ss}; %ppt code
    disp(Subj)
