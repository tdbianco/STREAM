...
% This function [EEGdata_Face_Obj, EEGdata_Checkers, Info_struct] = BrTUK_01a_Preprocess_Allcond(FT_dataname, Info_struct)
...
%% Read in the fieldtrip data and define the trials
    ...
    if ismember('Cz',Raw_trials.label)
        ...
        % faces and obj up & inv
        cfg = [];
        cfg.trials      = find(Raw_trials.trialinfo == 310 | Raw_trials.trialinfo == 312 | Raw_trials.trialinfo == 314 | Raw_trials.trialinfo == 316 | ...
        Raw_trials.trialinfo == 311 | Raw_trials.trialinfo == 313 | Raw_trials.trialinfo == 315 | Raw_trials.trialinfo == 317 | ...
        Raw_trials.trialinfo == 320 | Raw_trials.trialinfo == 321);
        ...
        % [EEG_data, IndividualERP, REFinfo] = BrTUK_01aa_preprocCondition(Raw_trials_cond, Condition, Info_struct)
            ...
            if ~isempty(EEGdata_Faces_Obj)
                % find the number of clean trials for each condition
                    FaceUp = find(EEGdata_Faces_Obj.trialinfo==310 | EEGdata_Faces_Obj.trialinfo==312 | ...
                        EEGdata_Faces_Obj.trialinfo==314 | EEGdata_Faces_Obj.trialinfo==316);
                    FaceInv = find(EEGdata_Faces_Obj.trialinfo==311 | EEGdata_Faces_Obj.trialinfo==313 | ...
                        EEGdata_Faces_Obj.trialinfo==315 | EEGdata_Faces_Obj.trialinfo==317);
                    ObjUp = find(EEGdata_Faces_Obj.trialinfo==320); 
                    ObjInv = find(EEGdata_Faces_Obj.trialinfo==321); 
